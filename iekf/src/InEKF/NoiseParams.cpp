...
#include "iekf/InEKF/NoiseParams.h"
...
NoiseParams::NoiseParams() {
    setGyroscopeNoise(1e-4);
    setAccelerometerNoise(1e-3);
    setGyroscopeBiasNoise(1e-10);
    setAccelerometerBiasNoise(1e-10);
    setLandmarkNoise(1e-3);
    setContactNoise(1e-3);
}
