...
#include "iekf/InEKF/RobotState.h"
#include "iekf/InEKF/LieGroup.h"
...
// Initialize with P
RobotState::RobotState(const Eigen::MatrixXd& P) :
    X_(Eigen::MatrixXd::Identity(5,5)), Theta_(Eigen::MatrixXd::Zero(6,1)), P_(P) {}
